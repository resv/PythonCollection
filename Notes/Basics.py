...
e.g.: A banking company is looking to automate one of its internal processes that takes 
about 40 minutes each week to complete. The automation process will take 10 hours total 
to complete. How many weeks will it be before the banking company begins to save time 
on the process and automation would be worthwhile?
...
Then, divide both sides by 40 to get:
	15 < weeks
It will take 15 weeks before the banking company starts saving time on the process. 
Remember, automating this process only needs to occur once. In addition, it helps 
employees by removing the need to think about the task and keeping up with the tracking of it.
