...
#### Managing streams | These are the redirectors that we can use to take control of the streams of our programs
...
### Operating with processes | These are some commands that are useful to know in Linux when interacting with processes. Not all of them are explained in videos, so feel free to investigate them on your own.
